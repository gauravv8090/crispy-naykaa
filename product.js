...
async function mySort(data) {
  ...
  if (data === "Priceddes") {
    var res = await fetch(
      "https://nykaa-deployed.onrender.com/products?_sort=off_price&_order=desc"
    );
    ...
    var res = await fetch(
      "https://nykaa-deployed.onrender.com/products?_sort=off_price&_order=asc"
    );
    var res2 = await res.json();
    console.log(res2);
    document.getElementById("PRODUCT").innerHTML = null;
    ...
    var res = await fetch(
      "https://nykaa-deployed.onrender.com/products?_sort=offer&_order=desc"
    );
    var res2 = await res.json();
    console.log(res2);
    document.getElementById("PRODUCT").innerHTML = null;
    ...
    var res = await fetch(
      "https://nykaa-deployed.onrender.com/products?_sort=card_title&_order=asc"
    );
    var res2 = await res.json();
    console.log(res2);
    document.getElementById("PRODUCT").innerHTML = null;
    ...
    var res = await fetch(
      "https://nykaa-deployed.onrender.com/products?_sort=rating&_order=desc"
    );
    var res2 = await res.json();
    console.log(res2);
    document.getElementById("PRODUCT").innerHTML = null;
...
async function myFilter(data) {
  console.log(data);
  var res = await fetch(
    `https://nykaa-deployed.onrender.com/products?category=${data}`
  );
  var res2 = await res.json();
  console.log(res2);
  document.getElementById("PRODUCT").innerHTML = null;
